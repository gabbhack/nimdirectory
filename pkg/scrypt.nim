...
<div class="content">
  <div class="container">
    <div class="container pt-10">
        <h3 class="mb-3 fw-bold display-6 pt-4">scrypt.nim</h3>
        <p class="tags">
                ...
                <span class="tag">
                    <button class="btn-tag pkg-btn-tag">password</button></a>
                </span>
                ...
                <span class="tag">
                    <button class="btn-tag pkg-btn-tag">deleted</button></a>
                </span>
            
        </p>
        <p class="pkg-desc">some("Binding and utilities for scrypt")</p>
        <a title="Copy" onclick="document.querySelector('#cmd').select();document.execCommand('copy');"
            alt="Copy on clipboard">
            <i class="fa fa-copy"></i>
        </a>
        <input id="cmd" onclick="this.select();" value="nimble install scrypt.nim" readonly="">
        <br>
  ...
  <div class="container pt-4">
    ...
    <div class="row mt-3">
      <div class="col-12 text-center mt-4 mx-auto">
        ...
        <p class="text-muted">
        Builded at 2023-04-24T01:20:47Z
        </p>
      </div>
    </div>
  </div>
